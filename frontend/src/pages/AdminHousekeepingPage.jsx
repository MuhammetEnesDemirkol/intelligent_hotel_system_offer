...
const AdminHousekeepingPage = () => {
  ...
  return (
    <div className="admin-housekeeping-page">
      <div className="admin-housekeeping-container">
        <h2 className="admin-housekeeping-title">Temizlik Takibi</h2>
            ...
            <tbody>
              {records.map((item) => (
                <tr key={item.id}>
                  ...
                  <td>
                    <select
                      className="admin-housekeeping-select"
                      value={item.status}
